// Lab06_哈希表选做3.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int main()
{
	std::string names[30] = { "YanJiaQuan" ,"WangYuXuan","PengWuLiang","ChenMengShi","LiuZiHao","ZhengMengDa","ZhengYanPei","LiShuang","YuLei","LiJian",
							...
							"ChenShi","MiErKe","ChenYuanHong","WangChunZhen","LiuJiaHeng","YanZhaoMing","GongXingLe","YuanZhengYang","ChenZhiGang","LuXiangNan" };
...
int getKey(std::string name) {
	...
	return key+n;//ASCII码值之和加上字符串长度作为地址
}
